...
本项目的外汇网格引擎与框架**复刻自 [金 @zaijin338191](https://x.com/zaijin338191) 开源的 [WGALL-ZJ005](https://github.com/ZAIJIN88/WGALL-ZJ005)**（五加密交易所整合网格机器人），在原作者开源基础上适配 MT5 外汇通道并深度增强（ATR 自适应间距、风控熔断、AI 助手、防重复挂单等）。

**感谢原作者的无私开源 🙏** —— 正是这份代码让我站在巨人的肩膀上完成了这套系统。请到 [X/Twitter](https://x.com/zaijin338191) 支持一下原作者！
